...
CREATE TABLE `blocked_data` (
  ...
  KEY `Blocked` (`Blocked`),
  KEY `Blocker` (`Blocker`),
  CONSTRAINT `blocked_data_ibfk_1` FOREIGN KEY (`Blocked`) REFERENCES `user` (`Username`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `blocked_data_ibfk_2` FOREIGN KEY (`Blocker`) REFERENCES `user` (`Username`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `blocked_data` VALUES (1,'Ben Dover','Heartbreaker'),(2,'Heartbreaker','Berb DiWire'),(3,'AlphabeticAfterimage','Berb DiWire');
